...
Le code ci-dessous fait le lien entre le backend Spring Boot et le microservice IA Python pour le traitement d'une vidéo et les requêtes de chat.
...
\noindent
\textbf{Description :} Ce code fait la construction des requêtes HTTP vers \texttt{/process} et \texttt{/chat}, puis récupère les réponses du microservice IA pour alimenter le flux métier du backend.
