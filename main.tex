...
\begin{figure}[H]
    ...
    \caption{Page d'upload (\texttt{/upload})}
...
\begin{figure}[H]
    ...
    \caption{Page \textit{My Videos} (\texttt{/myvideos})}
...
\begin{figure}[H]
    ...
    \caption{Page vidéo (\texttt{/video/:id})}
...
\begin{figure}[H]
    ...
    \caption{Page \textit{Settings} (\texttt{/settings})}
